  ...
  return (
    <div className="wrap">
      <div className="article">
        ...
        <p className="intro">Last updated September 26, 2026. Health questions are personal. FreeDoc, operated by Island Global Company, is built to know as little about you as possible. Health-specific details, including your rights under state health privacy laws, are in our <Link href="/health-data">Consumer Health Data Privacy Policy</Link>.</p>
