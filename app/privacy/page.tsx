...
export const metadata: Metadata = { title: 'Privacy Policy | FreeDoc', description: 'How FreeDoc handles your information.' };
  ...
  return (
    <div className="wrap">
      <div className="article">
        ...
        <p>Your description and answers are sent over an encrypted connection, through our host Vercel, to our AI provider, OpenAI, to generate your answer. They are used only to answer you. Under OpenAI’s API policies, they are not used to train AI models and may be kept by OpenAI for up to 30 days for abuse and safety monitoring. FreeDoc itself does not write them to any log or database.</p>
        <h2>Sharing</h2>
        ...
        <h2>Analytics</h2>
        <p>We use Vercel Web Analytics, which is cookie-free, to count visits and button taps, such as how many people tapped “Share,” and how often each care level is shown and for whom (for example, “a child”). These counts are anonymous and never include what you typed or your answers.</p>
