    ...
    <div className="wrap">
      <div className="article">
        ...
        <ul className="list">
          ...
          <li><strong>Vercel</strong> hosts FreeDoc. Your request passes through Vercel’s servers to reach OpenAI. Our code is designed not to write what you type to our logs or databases.</li>
        ...
        <p>FreeDoc is designed not to keep your symptom checks. Your result is shown in your browser tab and is cleared when you close or reset it. Our AI provider may keep a copy for up to 30 days, as described above. Anonymous visit and tap counts, which contain no health data, are kept in aggregate.</p>
        ...
        <h2>Your rights</h2>
        <p>Depending on where you live, you may have the right to confirm whether we collect your consumer health data, to access it, to get a list of the third parties and affiliates that received it, to delete it, and to withdraw consent. Because FreeDoc is designed not to keep symptom checks or link them to you, in most cases we will not hold any health data that we can match to you. We will still answer every request.</p>
